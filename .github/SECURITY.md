...
[**Report a vulnerability**](https://github.com/hassio-addons/app-audiobookshelf/security/advisories/new)
...
- Issues in Audiobookshelf itself; please report those directly to the
  [Audiobookshelf project](https://github.com/advplyr/audiobookshelf/security/policy).
...
This security policy covers the Audiobookshelf app in this repository: the app
